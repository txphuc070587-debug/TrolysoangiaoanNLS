...
<div class="main-header">
    ...
    <p>Tác giả: Trần Xuân Phúc - Trường PTDTBT Tiểu học Thèn Phàng - ĐT: 0914071718</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Xuân Phúc - Trường PTDTBT Tiểu học Thèn Phàng - ĐT: 0914071718</div>", unsafe_allow_html=True)
